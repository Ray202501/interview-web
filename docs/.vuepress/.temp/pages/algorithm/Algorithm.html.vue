<template><div><h1 id="面试官-说说你对算法的理解-应用场景" tabindex="-1"><a class="header-anchor" href="#面试官-说说你对算法的理解-应用场景"><span>面试官：说说你对算法的理解？应用场景？</span></a></h1>
<p><img src="https://static.vue-js.com/eca03690-1620-11ec-8e64-91fdec0f05a1.png" alt=""></p>
...
<h2 id="二、特性" tabindex="-1"><a class="header-anchor" href="#二、特性"><span>二、特性</span></a></h2>
<p>关于算法的五大特性，有如下：</p>
<ul>
...
<p>在前端领域中，数据结构与算法无法不在，例如现在的<code v-pre>vue</code>或者<code v-pre>react</code>项目，实现虚拟<code v-pre>DOM</code>或者<code v-pre>Fiber</code>结构，本质就是一种数据结构，如下一个简单的虚拟<code v-pre>DOM</code>：</p>
...
<span class="line">      <span class="token literal-property property">name</span><span class="token operator">:</span> <span class="token string">'lucifer'</span></span>
...
<span class="line">        <span class="token literal-property property">type</span><span class="token operator">:</span> <span class="token string">'span'</span><span class="token punctuation">,</span></span>
...
<div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p><code v-pre>vue</code>与<code v-pre>react</code>都能基于基于对应的数据结构实现<code v-pre>diff</code>算法，提高了整个框架的性能以及拓展性</p>
<p>包括在前端<code v-pre>javascript</code>编译的时候，都会生成对应的抽象语法树<code v-pre>AST</code>，其本身不涉及到任何语法，因此你只要编写相应的转义规则，就可以将任何语法转义到任何语法，也是<code v-pre>babel</code>， <code v-pre>PostCSS</code>, <code v-pre>prettier</code>， <code v-pre>typescript</code></p>
<p>除了这些框架或者工具底层用到算法与数据结构之外，日常业务也无处不在，例如实现一个输入框携带联想功能，如下：</p>
<p><img src="https://static.vue-js.com/682d16c0-1621-11ec-8e64-91fdec0f05a1.png" alt=""></p>
<p>如果我们要实现这个功能， 则可以使用前缀树，如下：</p>
<p><img src="https://static.vue-js.com/55a1ed50-1621-11ec-8e64-91fdec0f05a1.png" alt=""></p>
<p>包括前端可能会做一些对字符串进行相似度检测，例如&quot;每日一题&quot;和&quot;js每日一题&quot;两个字符串进行相似度对比，这种情况可以通过“最小编辑距离”算法，如果<code v-pre>a</code>和<code v-pre>b</code>的编辑距离越小，我们认为越相似</p>
...
<ul>
<li>https://baike.baidu.com/item/%E7%AE%97%E6%B3%95/209025</li>
<li>https://lucifer.ren/blog/2019/09/18/algorthimn-fe-1/</li>
</ul>
</div></template>
